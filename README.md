...
```
cd existing_repo
git remote add origin https://gitlab.com/Diego_Alejandro/sistema-de-gestion-g-talent.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Diego_Alejandro/sistema-de-gestion-g-talent/-/settings/integrations)
...
Copy and paste SoftUI-dashboard-Laravel-free folder in your projects folder. Rename the folder to your project's name
