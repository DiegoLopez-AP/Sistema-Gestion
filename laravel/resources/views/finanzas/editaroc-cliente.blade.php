...
@section('content')
    <h5> <a href="{{ url('facturacion') }}">OC Clientes </a> <i class="fas fa-caret-right"></i> Orden de Compra 9600140941
    </h5>
                ...
                <div class="card-body">
                    <form id="formulario" class="pb-0">
                        <div class="pagina activa p-2 " id="pagina1">
                            <h6 class="text-dark text-left fw-bold">Orden de Compra: 9600140941
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control text-truncate"
                                        value="El Bosque Norte N°0211 / Isidora Goyenechea N°2915, Piso 20" disabled>
                                </div>
                            </div>
                            <div class="row pt-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <label for="" class="form-label">N° Orden de Compra</label>
                                    <input type="text" class="form-control " value="9600140941" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                <div class="col-md-4">
                                    <label for="" class="form-label">Fecha Orden de Compra</label>
                                    <input type="text" class="form-control " value="01/06/2023">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="" id="">
                                        ...
                                        <option value="5">U.T.M</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label for="" class="form-label">Total</label>
                                    <input type="text" class="form-control " value="21.60" disabled>
                                </div>
                            </div>
                            <div class="row pt-3">
                                <div class="col-md-12">
                                    <label for="" class="form-label">Descripción</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="">
MANTENC.
APLICACIONES-INCIDENCIAS
GT-DS- 5376 MODIFICACION APP
FLUCTUACIONES
                            ...
                            <table class="table align-items-center table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <a href="#">
                                            <td class="text-left">
                                                <p class="text-xs font-weight-bold mb-0">5376</p>
                                            </td>
                                            <td class="text-left">
                                                <p class="text-xs font-weight-bold mb-0">COPEC</p>
                                            </td>
                                            <td class="text-left">
                                                <p class="text-xs font-weight-bold mb-0">Modificacion App Fluctuaciones</p>
                                            </td>
                                            <td class="text-left">
                                    ...
                                    <div class="accordion-body">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-striped">
                                                <thead>
                                                    <tr>
                                                        <th class="text-dark" scope="col">N°Factura</th>
                                                        <th class="text-dark" scope="col">tipo</th>
                                                        <th class="text-dark" scope="col">F.Emisión</th>
                                                        <th class="text-dark" scope="col">F.Vencimiento</th>
                                                        <th class="text-dark" scope="col">Neto</th>
                                                        <th class="text-dark" scope="col">IVA</th>
                                                        <th class="text-dark" scope="col">Total</th>
                                                        <th class="text-dark" scope="col">Neto en UF</th>
                                                        <th class="text-dark" scope="col">Estado</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">4475</th>
