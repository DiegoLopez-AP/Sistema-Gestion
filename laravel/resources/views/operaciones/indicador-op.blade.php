...
@section('content')
    <h5>Operaciones <i class="fas fa-caret-right"></i> Indicadores</h5>
    <div class="line_title"></div>
    <main class="ct-docs-content-col" role="main">
        <div class="ct-docs-page-title">
            <div class="row">
                <!-- GRAFICO COSTOS GENERALES -->
                            ...
                            <div class="container border-radius-lg w-100 ">
                                <div class="row">
                                    ...
                                    <div class="col-4 py-3 ps-0">
                                        ...
                                        <div class="progress w-75">
                                            <div class="progress-bar bg-gradient-primary w-90" role="progressbar"
                                    ...
                                    <div class="col-4 py-3 ps-0">
                                        ...
                                        <div class="progress w-75">
                                            <div class="progress-bar bg-gradient-primary w-30" role="progressbar"
                                ...
                                <div class="row">
                                    <div class="col-6 py-3 ps-0">
                                        ...
                                        <div class="progress w-75">
                                            <div class="progress-bar bg-gradient-primary  w-50" role="progressbar"
                                    ...
                                    <div class="col-6 py-3 ps-0">
                                        ...
                                        <div class="progress w-75">
                                            <div class="progress-bar bg-gradient-primary w-70" role="progressbar"
